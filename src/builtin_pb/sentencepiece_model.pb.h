...
class TrainerSpec PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kSplitByIntervalFieldNumber = 55,
    kDifferentialPrivacyClippingThresholdFieldNumber = 52,
    kDifferentialPrivacyNoiseLevelFieldNumber = 51,
    kSplitByBarlineFieldNumber = 56,
    kPhase1MergeBudgetFieldNumber = 57,
    kPhase2MergeBudgetFieldNumber = 58,
  ...
  bool has_split_by_interval() const;
  private:
  bool _internal_has_split_by_interval() const;
  public:
  void clear_split_by_interval();
  bool split_by_interval() const;
  void set_split_by_interval(bool value);
  private:
  bool _internal_split_by_interval() const;
  void _internal_set_split_by_interval(bool value);
  public:
  ...
  bool has_split_by_barline() const;
  private:
  bool _internal_has_split_by_barline() const;
  public:
  void clear_split_by_barline();
  bool split_by_barline() const;
  void set_split_by_barline(bool value);
  private:
  bool _internal_split_by_barline() const;
  void _internal_set_split_by_barline(bool value);
  public:

  // optional int32 phase1_merge_budget = 57 [default = 0];
  bool has_phase1_merge_budget() const;
  private:
  bool _internal_has_phase1_merge_budget() const;
  public:
  void clear_phase1_merge_budget();
  ::PROTOBUF_NAMESPACE_ID::int32 phase1_merge_budget() const;
  void set_phase1_merge_budget(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_phase1_merge_budget() const;
  void _internal_set_phase1_merge_budget(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:

  // optional int32 phase2_merge_budget = 58 [default = 0];
  bool has_phase2_merge_budget() const;
  private:
  bool _internal_has_phase2_merge_budget() const;
  public:
  void clear_phase2_merge_budget();
  ::PROTOBUF_NAMESPACE_ID::int32 phase2_merge_budget() const;
  void set_phase2_merge_budget(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_phase2_merge_budget() const;
  void _internal_set_phase2_merge_budget(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  bool split_by_interval_;
  ::PROTOBUF_NAMESPACE_ID::uint64 differential_privacy_clipping_threshold_;
  float differential_privacy_noise_level_;
  bool split_by_barline_;
  ::PROTOBUF_NAMESPACE_ID::int32 phase1_merge_budget_;
  ::PROTOBUF_NAMESPACE_ID::int32 phase2_merge_budget_;
  int model_type_;
...
inline bool TrainerSpec::has_split_by_interval() const {
  return _internal_has_split_by_interval();
}
...
inline bool TrainerSpec::split_by_interval() const {
  // @@protoc_insertion_point(field_get:sentencepiece.TrainerSpec.split_by_interval)
...
inline void TrainerSpec::set_split_by_interval(bool value) {
  _internal_set_split_by_interval(value);
  // @@protoc_insertion_point(field_set:sentencepiece.TrainerSpec.split_by_interval)
}
...
inline bool TrainerSpec::has_split_by_barline() const {
  return _internal_has_split_by_barline();
}
...
inline bool TrainerSpec::split_by_barline() const {
  // @@protoc_insertion_point(field_get:sentencepiece.TrainerSpec.split_by_barline)
...
inline void TrainerSpec::set_split_by_barline(bool value) {
  _internal_set_split_by_barline(value);
  // @@protoc_insertion_point(field_set:sentencepiece.TrainerSpec.split_by_barline)
}
...
inline bool TrainerSpec::has_phase1_merge_budget() const {
  return _internal_has_phase1_merge_budget();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TrainerSpec::phase1_merge_budget() const {
  // @@protoc_insertion_point(field_get:sentencepiece.TrainerSpec.phase1_merge_budget)
...
inline void TrainerSpec::set_phase1_merge_budget(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_phase1_merge_budget(value);
  // @@protoc_insertion_point(field_set:sentencepiece.TrainerSpec.phase1_merge_budget)
}
...
inline bool TrainerSpec::has_phase2_merge_budget() const {
  return _internal_has_phase2_merge_budget();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TrainerSpec::phase2_merge_budget() const {
  // @@protoc_insertion_point(field_get:sentencepiece.TrainerSpec.phase2_merge_budget)
