...
class TrainerSpec::_Internal {
 public:
  ...
  static void set_has_split_by_interval(HasBits* has_bits) {
    (*has_bits)[0] |= 8388608u;
  }
  static void set_has_split_by_barline(HasBits* has_bits) {
    (*has_bits)[0] |= 67108864u;
  }
  static void set_has_phase1_merge_budget(HasBits* has_bits) {
    (*has_bits)[0] |= 134217728u;
  }
  static void set_has_phase2_merge_budget(HasBits* has_bits) {
    (*has_bits)[0] |= 268435456u;
  }
  static void set_has_protected_pieces_file(HasBits* has_bits) {
    (*has_bits)[0] |= 1024u;
  }
};
...
TrainerSpec::TrainerSpec(const TrainerSpec& from)
  ...
  protected_pieces_file_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_protected_pieces_file()) {
    protected_pieces_file_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_protected_pieces_file(), 
      GetArena());
  }
...
void TrainerSpec::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      ...
      0, static_cast<size_t>(reinterpret_cast<char*>(&phase2_merge_budget_) -
      reinterpret_cast<char*>(&self_test_sample_size_)) + sizeof(phase2_merge_budget_));
  model_type_ = 1;
  vocab_size_ = 8000;
...
void TrainerSpec::SharedDtor() {
  ...
  protected_pieces_file_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
// @@protoc_insertion_point(message_clear_start:sentencepiece.TrainerSpec)
  ...
  if (cached_has_bits & 0x00000700u) {
    ...
    if (cached_has_bits & 0x00000400u) {
      protected_pieces_file_.ClearNonDefaultToEmpty();
    }
  }
  if (cached_has_bits & 0x0000f800u) {
    ::memset(&self_test_sample_size_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&enable_differential_privacy_) -
        reinterpret_cast<char*>(&self_test_sample_size_)) + sizeof(enable_differential_privacy_));
  }
  if (cached_has_bits & 0x00ff0000u) {
    ::memset(&treat_whitespace_as_suffix_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&split_by_interval_) -
        reinterpret_cast<char*>(&treat_whitespace_as_suffix_)) + sizeof(split_by_interval_));
  }
  if (cached_has_bits & 0xff000000u) {
    ::memset(&differential_privacy_clipping_threshold_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&phase2_merge_budget_) -
        reinterpret_cast<char*>(&differential_privacy_clipping_threshold_)) + sizeof(phase2_merge_budget_));
    model_type_ = 1;
    vocab_size_ = 8000;
    character_coverage_ = 0.9995f;
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 55:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 184)) {
          _Internal::set_has_split_by_interval(&_has_bits_);
          split_by_interval_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 56:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 192)) {
          _Internal::set_has_split_by_barline(&_has_bits_);
          split_by_barline_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 57:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 200)) {
          _Internal::set_has_phase1_merge_budget(&_has_bits_);
          phase1_merge_budget_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 58:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 208)) {
          _Internal::set_has_phase2_merge_budget(&_has_bits_);
          phase2_merge_budget_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 59:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 218)) {
          auto str = _internal_mutable_protected_pieces_file();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* TrainerSpec::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00800000u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(55, this->_internal_split_by_interval(), target);
  }

  // optional bool split_by_barline = 56 [default = false];
  if (cached_has_bits & 0x04000000u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(56, this->_internal_split_by_barline(), target);
  }

  // optional int32 phase1_merge_budget = 57 [default = 0];
  if (cached_has_bits & 0x08000000u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(57, this->_internal_phase1_merge_budget(), target);
  }

  // optional int32 phase2_merge_budget = 58 [default = 0];
  if (cached_has_bits & 0x10000000u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(58, this->_internal_phase2_merge_budget(), target);
  }

  // optional string protected_pieces_file = 59 [default = ""];
  if (cached_has_bits & 0x00000400u) {
    target = stream->WriteStringMaybeAliased(
        59, this->_internal_protected_pieces_file(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:sentencepiece.TrainerSpec)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    if (cached_has_bits & 0x00000400u) {
      total_size += 2 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
          this->_internal_protected_pieces_file());
    }
  ...
  if (cached_has_bits & 0xff000000u) {
    ...
    if (cached_has_bits & 0x08000000u) {
      total_size += 2 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32Size(
          this->_internal_phase1_merge_budget());
    }
    ...
    if (cached_has_bits & 0x10000000u) {
      total_size += 2 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32Size(
          this->_internal_phase2_merge_budget());
    }
...
// @@protoc_insertion_point(class_specific_merge_from_start:sentencepiece.TrainerSpec)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    if (cached_has_bits & 0x00000400u) {
      _internal_set_protected_pieces_file(from._internal_protected_pieces_file());
    }
    if (cached_has_bits & 0x00000800u) {
  ...
  if (cached_has_bits & 0x00ff0000u) {
    ...
    if (cached_has_bits & 0x00800000u) {
      split_by_interval_ = from.split_by_interval_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0xff000000u) {
    ...
    if (cached_has_bits & 0x04000000u) {
      split_by_barline_ = from.split_by_barline_;
    }
    if (cached_has_bits & 0x08000000u) {
      phase1_merge_budget_ = from.phase1_merge_budget_;
    }
    if (cached_has_bits & 0x10000000u) {
      phase2_merge_budget_ = from.phase2_merge_budget_;
    }
    if (cached_has_bits & 0x20000000u) {
...
void TrainerSpec::InternalSwap(TrainerSpec* other) {
  ...
  protected_pieces_file_.Swap(&other->protected_pieces_file_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TrainerSpec, phase2_merge_budget_)
      + sizeof(TrainerSpec::phase2_merge_budget_)
